            ...
            <AnimatePresence mode="popLayout">
              {!isAvatar && (
                ...
                <MotionContainer
                  ...
                  className={cn(
                    'bg-gradient-to-br from-primary/10 to-accent/10 aspect-square h-[90px] rounded-md border border-transparent transition-[border,drop-shadow]',
                    chatOpen && 'border-primary/30 drop-shadow-lg/10 delay-200'
                  )}
                >
                  <BarVisualizer
                    barCount={5}
